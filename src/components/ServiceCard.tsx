...
const ServiceCard = ({ number, title, items }: ServiceCardProps) => {
  return (
    <div className="relative overflow-hidden pt-[60px] lg:pl-[25px] pl-[20px]">
      ...
      <div className="relative z-10 text-white">
        <p className="text-[24px] font-semibold leading-[130%]">{title}</p>
        <ul className="space-y-5  text-[16px] font-medium leading-[130%] lg:mt-6 mt-4 text-[#DFDFDF]">
